...
module.exports = [
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 3,
      script: Buffer.from('6a0b01858addbd6002003b0227', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 3,
      script: Buffer.from('6a1e01858addbd6002003b0227ffffafafaaaa6d656d6f20666f722073656e64', 'hex'),
      asset: {
        allocation: [{ assetGuid: '1635229536', values: [{ n: 0, value: new BN(600000000) }, { n: 2, value: new BN(400000000) }] }]
      },
      memo: Buffer.from('memo for send')
  ...
  },
  {
    ...
    expected: {
      ...
      numOutputs: 12,
      script: Buffer.from('6a3e06858addbd600200300130858addbd61010213858addbd62020380640b30858addbd6302041d0509858addbd640206813e07800a858addbd650208310909', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 13,
      script: Buffer.from('6a4607858addbd600200300130858addbd61010213858addbd62020380640b30858addbd6302041d0509858addbd640206813e07800a858addbd650208310909858addbd66010c0a', 'hex'),
      asset: {
        allocation: [{ assetGuid: '1635229536', values: [{ n: 0, value: new BN(50000000) }, { n: 1, value: new BN(50000000) }] },
          { assetGuid: '1635229537', values: [{ n: 2, value: new BN(200000000) }] },
          { assetGuid: '1635229538', values: [{ n: 3, value: new BN(250000000) }, { n: 11, value: new BN(50000000) }] },
  ...
  },
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 3,
      script: Buffer.from('6a0c01858addbd60020131003100', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 3,
      script: Buffer.from('6a1001858addbd6002010100a0c2c3b27700', 'hex'),
      asset: {
        allocation: [{ assetGuid: '1635229536', values: [{ n: 1, value: new BN(1) }, { n: 0, value: new BN(999999999) }] }], ethaddress: Buffer.from('', 'hex')
      }
    }
  },
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 3,
      script: Buffer.from('6a0a0186c34002011d001300', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 2,
      script: Buffer.from('6a2001858addbd60020009014f149667de58c15475626165eaa4c9970e409e1181d0', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      rbf: true,
      numOutputs: 2,
      script: Buffer.from('6a2101858addbd60020009018015149667de58c15475626165eaa4c9970e409e1181d0', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      ...
      version: utils.SYSCOIN_TX_VERSION_SYSCOIN_BURN_TO_ALLOCATION,
      numOutputs: 2,
      script: Buffer.from('6a090188dea1914b010007', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      ...
      version: utils.SYSCOIN_TX_VERSION_SYSCOIN_BURN_TO_ALLOCATION,
      numOutputs: 3,
      script: Buffer.from('6a0b0188dea1914b0200590258', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      ...
      script: Buffer.from('6a0a01858addbd600101801f', 'hex'),
      asset: {
  ...
  },
  {
    ...
    expected: {
      ...
      version: utils.SYSCOIN_TX_VERSION_ALLOCATION_SEND,
      numOutputs: 3, // 3 because new opreturn will be created
      script: Buffer.from('6a0901858addbd60010159', 'hex'),
      asset: {
