...
module.exports = [{
  ...
  assetOpts: { precision: 8, symbol: 'CAT', updateflags: 31, balance: new BN(10000000000), maxsupply: new BN(100000000000) },
  assetOptsOptional: { contract: 'contractaddr', pubdata: '{"description":"publicvalue"}', prevcontract: '', prevpubdata: '' },
